...
Both are not _class-centric_.

## S3: characteristics of generic functions
...
- `UseMethod` initaites the dispatch one single argument, usually the first one
...
- make a new function call iwth arguments in the same order as there were supplied to the generic function


## S3: some useful funtions
```{r exp_glm, eval=FALSE}
#' Find available methods for a give class 
methods(class="glm") 
#' get a method for a given class and print
