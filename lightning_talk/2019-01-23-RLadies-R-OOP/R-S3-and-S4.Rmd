...
## S4: concrete class
define classes: `setClass`, `slots`, `presentation`, `contains`, `prototype`, `validity`.
...
## Excercise
Implement the SNP location class with slots
...
```
Set validationg such that all slots ahve the some length
Define `length` method 
