...
- functions and methods to handle the different manipulations to performed on teh objects
- more maintainable and reliable packges  
...
A generic function has a single expression wich is the call to `UseMethod`.
```{r S3_method}
