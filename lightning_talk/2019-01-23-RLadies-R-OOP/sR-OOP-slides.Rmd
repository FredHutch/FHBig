...
constructor(prototype, validation, initialization), getters, setters, show, 
...
## S4: generic functions/methods
How does the dispatch work? how about multiple dispatch?
...
getters: name, origin, destination
setters: ffnumber
unit test
...
```
## S4: class accessor 
- prefer user to access the internal of an object via accessos (getters and setters). R does not have provision of encapsulation.
...
setClass("subA1", contains = "A", slot = ...add slot here...)
```
```{r example_vartual}
